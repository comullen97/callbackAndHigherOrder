...
const multiply =(num1, num2, cbk) => cbk(num1 * num2)
...
multiply(4, 3, cbk => {
  console.log('The answer is ' + cbk) //should console.log 12
})
...
const last = (arr, cbk) => cbk(arr[arr.length - 1])
